...
# This program will illustrate how to implement the bucket sort algorithm

# Wikipedia says: Bucket sort, or bin sort, is a sorting algorithm that works by distributing the
# elements of an array into several buckets. Each bucket is then sorted individually, either using 
